...
public class ItemInit 
{
	...
	public static void registerItems(final RegistryEvent.Register<Item> event)
	{
		...
		event.getRegistry().register(new HoeItem(WatermelonItemTier.WATERMELON, -3, new Item.Properties().group(ElemelonItemGroup.instance)).setRegistryName("watermelon_hoe"));
		...
		event.getRegistry().register(new HoeItem(AirmelonItemTier.AIRMELON, -3, new Item.Properties().group(ElemelonItemGroup.instance)).setRegistryName("airmelon_hoe"));
		...
		event.getRegistry().register(new HoeItem(FiremelonItemTier.FIREMELON, -3, new Item.Properties().group(ElemelonItemGroup.instance)).setRegistryName("firemelon_hoe"));
		...
		event.getRegistry().register(new HoeItem(EarthmelonItemTier.EARTHMELON, -3, new Item.Properties().group(ElemelonItemGroup.instance)).setRegistryName("earthmelon_hoe"));
		...
		event.getRegistry().register(new HoeItem(MelonItemTier.MELON, -3.2F, new Item.Properties().group(ElemelonItemGroup.instance)).setRegistryName("melon_hoe"));
		...
		event.getRegistry().register(new HoeItem(UltimelonItemTier.ULTIMELON, -2, new Item.Properties().group(ElemelonItemGroup.instance)).setRegistryName("ultimelon_hoe"));
