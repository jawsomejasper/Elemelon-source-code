...
import com.jawsomejasper.elemelonmod.objects.blocks.EssenceOre;
...
public class BlockInit 
{
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event)
	{
		...
		event.getRegistry().register(new EssenceOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3).sound(SoundType.STONE)).setRegistryName("watermelon_essence_ore"));
		event.getRegistry().register(new EssenceOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3).sound(SoundType.STONE)).setRegistryName("airmelon_essence_ore"));
		event.getRegistry().register(new EssenceOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3).sound(SoundType.STONE)).setRegistryName("firemelon_essence_ore"));
		event.getRegistry().register(new EssenceOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3).sound(SoundType.STONE)).setRegistryName("earthmelon_essence_ore"));
		event.getRegistry().register(new EssenceOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3).sound(SoundType.STONE)).setRegistryName("melon_essence_ore"));
	}
